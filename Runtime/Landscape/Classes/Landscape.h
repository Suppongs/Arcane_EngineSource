...
public:
	...
	*/
	...
	LANDSCAPE_API void CopyOldDataToCustomLayer();
	LANDSCAPE_API void CopyOldDataToCustomLayer(ALandscapeProxy* InProxy);
	/* Custom Edit End */
	...
	LANDSCAPE_API void ReleaseLayersRenderingResource();
